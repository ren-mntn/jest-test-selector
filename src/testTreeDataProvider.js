  ...
  function TestTreeItem(label, collapsibleState, type, filePath, testCase) {
    ...
    switch (type) {
      case "file":
        ...
        _this.tooltip = "\u30D5\u30A1\u30A4\u30EB: ".concat(
          path.basename(filePath)
        );
        _this.description = path.relative(
          ((_b =
      ...
      case "testCase":
        ...
        _this.tooltip = testCase
          ? "\u30C6\u30B9\u30C8: "
              .concat(testCase.name, " (\u884C: ")
              .concat(testCase.lineNumber, ")")
          : label;
        _this.description = testCase
          ? "\u884C: ".concat(testCase.lineNumber)
          : "";
        _this.command = {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            vscode.window.showErrorMessage(
              "\u30C6\u30B9\u30C8\u30C4\u30EA\u30FC\u306E\u69CB\u7BC9\u30A8\u30E9\u30FC: ".concat(
                error_1 instanceof Error ? error_1.message : "不明なエラー"
              )
            );
            return [3 /*break*/, 4];
          case 4:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              (0, testExtractor_1.extractTestCases)(filePath),
            ];
          case 1:
            testCases = _b.sent();
            ...
            for (
              ...
              _loop_1 = function (descName) {
                // 既存のノードを探す
                var descNode = currentNode.children.find(function (child) {
                  return child.type === "describe" && child.name === descName;
                });
                // 存在しなければ新規作成
                if (!descNode) {
                  descNode = {
              ...
              for (
                _a = 0, describePath_1 = describePath;
                _a < describePath_1.length;
                _a++
              ) {
          ...
          case 2:
            error_2 = _b.sent();
            vscode.window.showErrorMessage(
              "\u30C6\u30B9\u30C8\u30C4\u30EA\u30FC\u306E\u69CB\u7BC9\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ".concat(
                error_2 instanceof Error ? error_2.message : "不明なエラー"
              )
            );
            return [3 /*break*/, 3];
          case 3:
